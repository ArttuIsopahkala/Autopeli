<?php
/**
 * cpp-syntax-highlighter.php
 *
 * PHP-ohjelma, joka tarjoaa kÃ¤yttÃ¶liittymÃ¤n tietyssÃ¤ web-kansiossa sijaitsevien 
 * C++-ohjelmien syntaksin korostamiseen web-sivulla.
 *
 * KÃ¤yttÃ¤Ã¤ syntaksin korostukseen:
...
<head>
	...
	<script type="text/javascript" src="{$jsurl}shBrushCpp.js"></script>
...
// jos seurattu linkkia ja kansiossa oleva tiedosto kÃ¤sillÃ¤:
...
if (!$found) echo "<li>TÃ¤ssÃ¤ kansiossa ei ole tiedostoja pÃ¤Ã¤tteillÃ¤: $file_extensions!\n";
echo "</ul>";
}
?> 